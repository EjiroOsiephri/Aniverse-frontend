        ...
        >
          ...
          <div className="bg-white relative z-50 rounded-2xl shadow-2xl p-8">
            ...
            <div className="text-center mb-6">
              ...
              <h2 className="text-4xl py-2 text-left font-bold text-gray-900 mb-3">
                Sign up
              </h2>
              <p className="text-gray-600 text-left text-sm leading-relaxed">
                Sign up to chat with your AI anime companion, save avatars, and
                join the community.
              </p>
            </div>
            ...
            <div className="space-y-5">
              ...
              <motion.button
                ...
                className="w-full py-3 px-4 text-white font-medium rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl mt-2"
...
export default AnimeSignUpPage;
